...
def receive_new_frame(data_dict):
    ...
    if "labeledMarkers" in data_dict:
        for marker in data_dict["labeledMarkers"]:
            marker_id = marker[0]
            marker_pos = marker[1]
            process_marker_pos(marker_id, marker_pos)
    ...
    while is_looping:
        ...
        if len(inchars)>0:
            ...
            if c1 == 'h' :
                ...
                print_level = streaming_client.set_print_level(5)
