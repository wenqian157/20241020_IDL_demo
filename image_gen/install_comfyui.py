...
def download_models(install_folder):
    ...
    #     os.path.join(models_folder, "checkpoints/realvisxl-v50.safetensors"),
    # )
    # download_file(
    #     "https://huggingface.co/imagepipeline/Copax-TimeLessXL-SDXL1.0/blob/main/copaxTimelessxlSDXL1_v9.safetensors",
    #     os.path.join(models_folder, "checkpoints/copaxTimelessxlSDXL1_v9.safetensors"),
    # )

    # # Download CLIP models
    # download_file(
    #     "https://huggingface.co/lllyasviel/flux1_dev/blob/main/flux1-dev-fp8.safetensors",
    #     os.path.join(models_folder, "clip/flux1-dev-fp8.safetensors"),
    # )
    # download_file(
    #     "https://huggingface.co/comfyanonymous/flux_text_encoders/blob/main/clip_l.safetensors",
    #     os.path.join(models_folder, "clip/clip_l.safetensors"),
    # )
    ...
    #     os.path.join(
    #         models_folder, "controlnet/InstantX_FLUX.1-dev-Controlnet-Canny.safetensors"
    #     ),
    # )
    # download_file(
    #     "https://huggingface.co/lllyasviel/control_v11p_sd15_normalbae/blob/main/diffusion_pytorch_model.safetensors",
    #     os.path.join(
    #         models_folder, "controlnet/control_v11p_sd15_normalbae.safetensors"
    #     ),
    # )
    ...
    #     os.path.join(
    #         models_folder,
    #         "clip_vision/to-use-with_ip-adapter-plus_sdxl_vit-h.safetensors",
    #     ),
    # )
    ...
    #     os.path.join(models_folder, "ipadapter/ip-adapter-plus_sdxl_vit-h.safetensors"),
    # )
